...
export const metadata: Metadata = {
  ...
  description:
    'Fathom Your Future. Tell us your vision, and we’ll show you the vehicle built to take you there. A guided moment of self-discovery.',
  openGraph: {
    title: 'Discover Your Next You',
    description: 'Fathom Your Future — a guided moment of self-discovery.',
